...
class IProductRepository(ABC):
    ...
    Las implementaciones concretas estaran en la capa de infraestructura
    """

    @abstractmethod
    def get_all(self) -> List[Product]:
        """
        TODO: Define el metodo para obtener todos los productos
        No implementes nada, solo la firma del metodo
        """
        pass
